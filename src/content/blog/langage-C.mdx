...
il est existe plusieur manière d'identifier une variables, elle peuvent
commencer soit par une lettre majuscule 'A'-'Z' ou minuscule 'a'-'z', ou alors
du caractère '\_' (blanc souligné, tiret bas ou underscore) ou alors de Chiffres
('0'-'9')
